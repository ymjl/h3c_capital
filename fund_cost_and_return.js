function generatePlot() {
  ...
  // 计算数据
  var return_rates = Array.from(Array(Math.floor(6/step_size) - Math.floor(baseline_return/step_size)), (x, i) => (i + Math.floor(baseline_return/step_size)) * step_size);  // 基金收益率列表
